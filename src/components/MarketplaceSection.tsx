...
export const MarketplaceSection = () => {
  ...
  // 🔥 Pega apenas os 3 primeiros hackathons
  const limitedHackathons = hackathons.slice(0, 3);
    ...
    <>
      ...
      <section id="marketplace" className="py-20 bg-background/50">
        <div className="container mx-auto px-4">
          ...
          {!isLoading && limitedHackathons.length === 0 && (
              ...
              return (
                ...
                >
                  <HackathonCard
                    ...
                    participants={Math.floor(Math.random() * 100)} // placeholder
                    maxParticipants={200} // placeholder
                    startDate={new Date(h.startDate).toLocaleDateString(
                      "pt-BR"
                    )}
                    endDate={new Date(h.endDate).toLocaleDateString("pt-BR")}
                    prize="R$ 0,00" // placeholder
                    tags={["Hackathon"]}
                    status={status}
                  />
                </motion.div>
        ...
        >
          <Button 
            size="lg"
              className="bg-gradient-primary shadow-neon hover:shadow-glow font-exo font-semibold group"
              onClick={() => navigate("/marketplace")}
          >
            Ver Todos os Hackathons
